    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Product Category Management</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <table id="branchTable" class="table table-bordered table-striped text-center">
                            ...
                            <tbody>
                                ...
                                $result = getAllDataOfProductCategoryTable(" ");
                                $i = 1;
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-info dropdown-toggle dropdown-toggle dropdown-icon" data-toggle="dropdown">
                                                ...
                                                <div class="dropdown-menu text-center" role="menu">
                                                    ...
                                                    <a class="dropdown-item bg-default" href="#" onclick="promtEditProductCategory('<?php echo $id; ?>', '<?php echo $result[$key]['name']; ?>', '<?php echo $result[$key]['branch_id']; ?>')">Edit</a>


                                                    <?php if ($result[$key]['status'] == 1) { ?>
                                                    <a class="dropdown-item bg-warning" href="#" onclick="statusToggler('Do You Want To Deactivate The Product Category ?','product_category','<?php echo $id; ?>','2')">Deactivate</a>
                                                    <?php
                                                        } else {
                                                        ?>
                                                    <a class="dropdown-item bg-success" href="#" onclick="statusToggler('Do You Want To Activate The Product Category ?','product_category','<?php echo $id; ?>','1')">Activate</a>
                                                    <?php
                                                        }
                                                        ?>
                                                    <a class="dropdown-item bg-danger" href="#" onclick="statusToggler('Do You Want To Delete The Product Category ? Once Done, It Can Not Be Undone !','product_category','<?php echo $id; ?>','0')">Delete</a>
                                                </div>
                                            </button>
                                        </div>
                                    </td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Product Category Name" name="addProductCategoryName" id="addProductName" required><br>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Select A Branch for the Product Category </label>
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-primary" id="addProductCategorySaveButton" onclick="saveProductCategory()">Save</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Product Category Name</label>
                                <input type="text" class="form-control" placeholder="Product Category Name" name="editProductName" id="editProductName" required><br>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Edit Product Category Branch</label>
                        ...
                        <!-- <div class="col-md-4">
                            <div class="form-group">
                                <label>Edit Product Category Sub Branch </label>
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-primary" id="editProductSaveButton" onclick="saveEditProductCategory()">Save</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
...
//            return false;
        ...
        function promtEditProductCategory(id, name, branchId,  ) {
            $('.loader-holder').show();
 ...
 // return false;
            if (name != "" && branchId != "") {
                ...
                $.ajax({
                        ...
                        url: 'ajaxfunctions.php',
                        data: {
                            funName: "saveEditProductCategory",
