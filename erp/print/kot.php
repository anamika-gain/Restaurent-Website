...
<!-- 
 ...
 -->                        <div class="col-12 mt-1 mb-1" style="border-bottom: 1px dashed"></div>
                        ...
                        <table class="table mb-1 text table-borderless" >
                            <thead>
                                <tr style="border-bottom: 1px dashed "><th>#</th>
                        ...
                        ?>
                                ...
                                <tr style="border-bottom: 1px dashed ">
                                    ...
                                    <th class="fk-print-text sm-text text-capitalize text-center"><b><?php echo $orderItemTableDetails[$oitdKey]['product_quantity']; ?></b></th>
                        ...
                        <table class="table mt-1 mb-1 text-center table-borderless">
                            <thead>
                                <tr>
                                <span scope="col" class="fk-print-text fk-print-text--bold xsm-text text-capitalize text-center">Remarks: <?php echo $orderProcessTableDetails['remarks'];?></span>
                            <br>
                            <br>    
                            </tr>
                                <tr>
