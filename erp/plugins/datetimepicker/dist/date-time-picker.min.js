! function (t) {
    ...
    p.prototype._getDateByFormat = function (t) {
        ...
        t.options.$target.on("focus", function () {
            ...
            if (t.options.$dateTimePicker.data({
                    ...
                    mode: t.options.mode
                }), t.options.refreshPicker(), "dateTime" == t.options.mode) i = p.getHours() > 9 ? p.getHours() : "0" + p.getHours(), a = p.getMinutes() > 9 ? p.getMinutes() : "0" + p.getMinutes(), d = p.getSeconds() > 9 ? p.getSeconds() : "0" + p.getSeconds(), t.options.$dateTimePicker.find(".J-dtp-date-btn-wrap").hide(), t.options.$dateTimePicker.find(".J-dtp-time-btn-wrap").show();
            else {
                var f = null,
                    g = null,
                    x = new Date;
        ...
        Date.prototype.format = function (t) {
            ...
            for (var p in e) new RegExp("(" + p + ")").test(t) && (t = t.replace(RegExp.$1, 1 == RegExp.$1.length ? e[p] : ("00" + e[p]).substr(("" + e[p]).length)));
            return t
        }, n(2);
        var e = t.Deferred();
        t(function () {
    ...
    function p(t, e) {
        for (var n = 0; n < t.length; n++) {
            ...
            if (i) {
                i.refs++;
                for (var a = 0; a < i.parts.length; a++) i.parts[a](p.parts[a]);
                for (; a < p.parts.length; a++) i.parts.push(o(p.parts[a], e))
            } else {
                for (var d = [], a = 0; a < p.parts.length; a++) d.push(o(p.parts[a], e));
                u[p.id] = {
                    id: p.id,
                    refs: 1,
                    parts: d
    ...
    function a(t, e) {
        var n = g(),
            p = v[v.length - 1];
        if ("top" === t.insertAt) p ? p.nextSibling ? n.insertBefore(e, p.nextSibling) : n.appendChild(e) : n.insertBefore(e, n.firstChild), v.push(e);
        else {
    ...
    function o(t, e) {
        ...
        } else t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = s(e), p = l.bind(null, n), i = function () {
            d(n), n.href && URL.revokeObjectURL(n.href)
        }) : (n = r(e), p = m.bind(null, n), i = function () {
            d(n)
        });
        return p(t),
            function (e) {
    ...
    function m(t, e) {
        var n = e.css,
            p = e.media;
        if (p && t.setAttribute("media", p), t.styleSheet) t.styleSheet.cssText = n;
        else {
